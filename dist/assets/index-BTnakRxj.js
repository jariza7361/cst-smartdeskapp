(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&o(l)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function ue(e="en"){let t={},n=e;return{async init(o="en"){try{n=o;const[s,i]=await Promise.all([fetch("/i18n/en.json").then(l=>l.json()).catch(()=>({})),fetch("/i18n/es.json").then(l=>l.json()).catch(()=>({}))]);return t={en:s,es:i},!0}catch(s){return console.error("Failed to load translations:",s),t={en:{},es:{}},!1}},t(o,s){return(t[s||n]||t.en||{})[o]??o},setLanguage(o){n=o}}}function Ue(e="",t="",n=null){let o=[];if(n){let s=typeof n=="string"?n:JSON.stringify(n);o.push("CONTEXT_JSON="+s.slice(0,3e3))}return e&&o.push(e.trim()),t&&o.push(t.trim()),o.join(`

`).trim()}function ke(e){const t=String(e||""),n=t.toLowerCase(),o=He(n),s=l=>We(t,n,l,240),i=Array.from(t.matchAll(/https?:\/\/\S+/g)).map(l=>l[0]);return{carrier:o,fees:s(/(fee|charge|surcharge)/g),dates:s(/(effective|date|updated)/g),prohibited:s(/(prohibit|not allowed|forbidden|restriction)/g),links:i,rawLength:t.length}}function He(e){const t=/(verizon|at&t|att|cricket|t-mobile|tmobile)/.exec(e);if(!t)return"unknown";const n=t[1];return n==="att"?"at&t":n==="tmobile"?"t-mobile":n}function We(e,t,n,o){const s=n.exec(t);if(!s)return null;const i=s.index;return e.slice(i,Math.min(i+o,e.length))}const pe={BASE_URL:"/",DEV:!1,MODE:"production",PROD:!0,SSR:!1};let J="en",R={name:"",empId:"",extension:"",coach:"",type:"english"},b={shiftStart:"",shiftEnd:"",breakDuration:15,lunchDuration:30,currentStatus:"available",nextBreak:null,nextLunch:null,onBreak:!1,breakStartTime:null};const r={settings:null,i18n:null,copilotReachable:null,lang:"en",jsErrors:[]};async function Ie(){try{console.log("Initializing CST SmartDesk v1.0..."),it(),r.i18n=ue(),await r.i18n.init(J),Ge(),Ye(),ye(),setInterval(ye,1e3),console.log("CST SmartDesk v1.0 initialized successfully")}catch(e){console.error("Failed to initialize app:",e)}}function Ge(){const e=localStorage.getItem("cst_expert_info");e?(R=JSON.parse(e),Ce()):Ke();const t=localStorage.getItem("cst_schedule_info");t&&(b={...b,...JSON.parse(t)},Be())}function ze(){localStorage.setItem("cst_expert_info",JSON.stringify(R)),Ce()}function Ce(){const e=document.getElementById("expertName"),t=document.getElementById("expertEmpId"),n=document.getElementById("expertExtension"),o=document.getElementById("expertCoach");e&&(e.textContent=R.name||"Not Set"),t&&(t.textContent=R.empId||"Not Set"),n&&(n.textContent=R.extension||"Not Set"),o&&(o.textContent=R.coach||"Not Set")}function ye(){const e=new Date,t=e.toLocaleTimeString(),n=e.toLocaleDateString(),o=document.getElementById("currentTime");o&&(o.textContent=`${t} - ${n}`),Je(e)}function Je(e){if(!b.shiftStart||!b.shiftEnd){const n=document.getElementById("scheduleStatus");n&&(n.textContent="Schedule not set");return}const t=document.getElementById("scheduleStatus");if(b.onBreak){const n=new Date(b.breakStartTime),o=new Date(n.getTime()+b.breakDuration*6e4),s=Math.ceil((o-e)/6e4);if(s<=0)xe(),we("Break time is over! Please return to available status.");else{const i=document.getElementById("breakTimeLeft");i&&(i.textContent=`Break ends in ${s} minutes`),t&&(t.textContent=`On Break (${s}m left)`)}}else t&&(t.textContent=`Available - ${b.currentStatus}`),Ve(e)}function Ve(e){const t=e.getHours()*60+e.getMinutes();if(t>=720&&t<=840){const n=localStorage.getItem("cst_last_lunch_alert"),o=e.toDateString();n!==o&&(localStorage.setItem("cst_last_lunch_alert",o),be("lunch","Time for lunch break!"))}if(t>=900&&t<=960){const n=localStorage.getItem("cst_last_break_alert"),o=e.toDateString();n!==o&&(localStorage.setItem("cst_last_break_alert",o),be("break","Time for your afternoon break!"))}}function be(e,t){we(t);const n=document.createElement("div");n.className="break-alert",n.innerHTML=`
  ...
  `,document.body.appendChild(n),n.style.display="block",setTimeout(()=>{n.parentNode&&n.parentNode.removeChild(n)},3e4)}function we(e){const t=new Audio("data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmEcCDuM0fPTgjMGH3PE8OObTgwOWK/n77JiGg");t.volume=.3,t.play().catch(()=>{"Notification"in window&&Notification.permission==="granted"&&new Notification("CST SmartDesk",{body:e})}),ie(e)}function xe(){b.onBreak=!1,b.breakStartTime=null,b.currentStatus="available";const e=document.getElementById("breakTimer");e&&(e.style.display="none"),me(),ie("Break ended - Status: Available")}function me(){localStorage.setItem("cst_schedule_info",JSON.stringify(b)),Be()}function Be(){const e=document.getElementById("scheduleStatus");e&&(b.onBreak?e.textContent=`On ${b.currentStatus}`:e.textContent=b.shiftStart?`Available (${b.shiftStart} - ${b.shiftEnd})`:"Schedule not set")}function Ke(){const e=document.getElementById("setupWizard");e&&(e.style.display="block")}function Ye(){const e=document.getElementById("setupForm");e&&e.addEventListener("submit",Ze),document.addEventListener("click",i=>{i.target.classList.contains("close-modal")&&se(i.target.closest(".modal"))}),Xe();const t=document.getElementById("languageToggle");t&&t.addEventListener("click",Ae);const n=document.getElementById("scheduleSettings");n&&n.addEventListener("click",Le);const o=document.getElementById("endBreak");o&&o.addEventListener("click",xe);const s=document.getElementById("helpBtn");s&&s.addEventListener("click",Te),"Notification"in window&&Notification.permission==="default"&&Notification.requestPermission(),document.addEventListener("keydown",Qe)}function Qe(e){if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA")return;const t=document.querySelector('.modal[style*="block"]');if(t){e.key==="Escape"&&se(t);return}const n=e.key.toLowerCase(),o={f:"fmip",h:"hero-denial",b:"byod",s:"spanish-templates",a:"auto-fill",e:"escalations",n:"alpha-notes",r:"rpfr",t:"settings",l:"language-toggle",p:"performance","?":"help"};o[n]&&(e.preventDefault(),n==="?"?Te():fe(o[n]))}function Ze(e){e.preventDefault();const t=new FormData(e.target);R.name=t.get("name"),R.empId=t.get("empId"),R.extension=t.get("extension"),R.coach=t.get("coach"),R.type=t.get("type"),t.get("shiftStart")&&(b.shiftStart=t.get("shiftStart"),b.shiftEnd=t.get("shiftEnd"),b.breakDuration=parseInt(t.get("breakDuration"))||15,b.enableBreakAlerts=!0,b.enableAudioAlerts=!0,me()),ze(),se(document.getElementById("setupWizard")),ie("Welcome to CST SmartDesk v1.0! Setup complete.")}function Xe(){document.querySelectorAll(".smart-card").forEach(t=>{t.addEventListener("click",()=>{const n=t.dataset.card;fe(n)})})}function fe(e){switch(console.log(`Opening ${e} modal`),st("smartPanelUsage"),e){case"fmip":lt();break;case"hero-denial":ct();break;case"byod":rt();break;case"spanish-templates":dt();break;case"auto-fill":ut();break;case"escalations":pt();break;case"alpha-notes":mt();break;case"rpfr":ft();break;case"settings":Le();break;case"language-toggle":Ae();break;case"performance":et();break;default:console.log(`No handler for card type: ${e}`)}}function et(){const e=tt(),t=O("Performance Metrics",`
  ...
  `);P(t)}function tt(){const e=localStorage.getItem("cst_session_start")||new Date().toISOString(),t=new Date,n=new Date(e),o=Math.floor((t-n)/6e4),s=JSON.parse(localStorage.getItem("cst_performance_stats")||"{}"),i=t.toDateString(),l=s[i]||{smartPanelUsage:0,notesGenerated:0,clipboardActions:0,escalations:0,breaksOnTime:0,totalBreaks:0};return{sessionTime:ot(o),smartPanelUsage:l.smartPanelUsage,notesGenerated:l.notesGenerated,clipboardActions:l.clipboardActions,escalations:l.escalations,breakCompliance:l.totalBreaks>0?Math.round(l.breaksOnTime/l.totalBreaks*100):100}}function nt(e){const t=[];return e.smartPanelUsage>10?t.push("<li>✅ Great SmartPanel usage! You're leveraging automation effectively.</li>"):t.push("<li>💡 Try using more SmartPanel cards to boost productivity.</li>"),e.clipboardActions>5&&t.push("<li>⚡ High copy-paste efficiency - you're working smart!</li>"),e.breakCompliance>=80?t.push("<li>🎯 Excellent break compliance - great work-life balance!</li>"):t.push("<li>⏰ Consider taking regular breaks to maintain productivity.</li>"),e.escalations===0&&t.push("<li>🔥 Zero escalations today - excellent problem resolution!</li>"),t.length===0&&t.push("<li>📈 Keep up the great work! Your metrics look good.</li>"),t.join("")}function ot(e){const t=Math.floor(e/60),n=e%60;return t>0?`${t}h ${n}m`:`${n}m`}function st(e,t=1){const n=new Date().toDateString(),o=JSON.parse(localStorage.getItem("cst_performance_stats")||"{}");o[n]||(o[n]={smartPanelUsage:0,notesGenerated:0,clipboardActions:0,escalations:0,breaksOnTime:0,totalBreaks:0}),o[n][e]+=t,localStorage.setItem("cst_performance_stats",JSON.stringify(o))}function it(){localStorage.getItem("cst_session_start")||localStorage.setItem("cst_session_start",new Date().toISOString())}function Le(){const e=O("Schedule Settings",`
  ...
  `);P(e);const t=document.getElementById("scheduleForm");t&&t.addEventListener("submit",at)}function at(e){e.preventDefault();const t=new FormData(e.target);b.shiftStart=t.get("shiftStart"),b.shiftEnd=t.get("shiftEnd"),b.breakDuration=parseInt(t.get("breakDuration")),b.lunchDuration=parseInt(t.get("lunchDuration")),b.enableBreakAlerts=document.getElementById("enableBreakAlerts").checked,b.enableAudioAlerts=document.getElementById("enableAudioAlerts").checked,me(),se(document.querySelector(".modal")),ie("Schedule settings saved successfully!")}function Te(){const e=O("Keyboard Shortcuts",`
  ...
  `);P(e)}function lt(){const e=O("FMIP Workflow Assistant",`
  ...
  `);P(e)}function ct(){const e=O("HERO Denial Scripts",`
  ...
  `);P(e)}function rt(){const e=O("BYOD Logic Helper",`
  ...
  `);P(e)}function dt(){const e=O("Spanish Templates",`
  ...
  `);P(e)}function ut(){const e=O("Auto-Fill Forms",`
  ...
  `);P(e)}function pt(){const e=O("Escalations Tracking",`
  ...
  `);P(e)}function mt(){const e=O("Alpha Notes Generator",`
  ...
  `);P(e)}function ft(){const e=O("RPFR vs PFR Guide",`
  ...
  `,n}function P(e){document.body.appendChild(e),e.style.display="block"}function se(e){e&&(e.style.display="none",e.parentNode&&e.parentNode.removeChild(e))}function ie(e){const t=document.createElement("div");t.className="notification",t.textContent=e,document.body.appendChild(t),setTimeout(()=>{t.classList.add("show")},100),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>{document.body.removeChild(t)},300)},3e3)}function Ae(){J=J==="en"?"es":"en",r.i18n.init(J),console.log(`Language switched to: ${J}`)}document.addEventListener("DOMContentLoaded",Ie);window.addEventListener("error",e=>{console.error("Global error:",e),r.jsErrors.push({message:e.message,filename:e.filename,line:e.lineno,timestamp:new Date().toISOString()})});typeof module<"u"&&module.exports&&(module.exports={expertInfo:R,state:r,init:Ie,handleCardClick:fe});let ce=null,j=!1,K=!1,U=0,V=null,ee=null;try{const e=t=>{try{r.jsErrors=r.jsErrors||[],t&&r.jsErrors[0]!==t&&(r.jsErrors.unshift(String(t)),r.jsErrors=r.jsErrors.slice(0,5));try{$()}catch{}}catch{}};window.addEventListener("error",t=>{const n=t?.error?.message||t?.message||"Unknown error";e("Error: "+n)}),window.addEventListener("unhandledrejection",t=>{const n=t?.reason,o=n&&(n.message||n.toString?.())||"Unhandled rejection";e("Promise: "+o)})}catch{}function H(){try{return!!(typeof navigator<"u"&&"webdriver"in navigator&&navigator.webdriver)}catch{return!1}}function ht(e){r.engine=e,localStorage.setItem("cst_engine",e),C("Engine: "+e)}try{window.setEngine=ht}catch{}async function gt(e){return`[LOCAL ENGINE]

`+String(e||"")+`

(Template assist applied.)`}function yt(e){const t=document.querySelector("#copilotSample");if(t&&(!t.options||t.options.length===0)){const n=document.createElement("option");n.value="serve_solve_sell";const o={en:"Serve / Solve / Sell (starter)",es:"Atender / Resolver / Ofrecer (inicio)"};n.textContent=o[e]||o.en,n.setAttribute("data-prompt","Follow Observe-AI style. In English and Spanish, write a concise, professional response that (1) serves: acknowledge & empathize, (2) solves: steps, checks, policy guardrails, (3) sells: set expectation, optional upsell or value reinforcement. Ask a confirm-at-end question. If the user pasted context, adapt to it."),t.appendChild(n)}}document.addEventListener("DOMContentLoaded",async()=>{let e=!1;try{e=!!(import.meta&&pe&&!1)}catch{}e||(e=new URLSearchParams(location.search).get("codex")==="1"||localStorage.getItem("codexMode")==="1"),e&&document.documentElement.classList.add("codex"),r.redirectTo=Ct();try{typeof H=="function"&&H()&&window.addEventListener("unhandledrejection",k=>{k.preventDefault?.()},{capture:!0})}catch{}const t=localStorage.getItem("lang")||"en";r.i18n=await ue(t),r.lang=t,Oe();let n;try{typeof H=="function"&&H()?(localStorage.setItem("welcomeSeen","1"),n=!1):n=e||localStorage.getItem("welcomeSeen")!=="1"}catch{n=e||localStorage.getItem("welcomeSeen")!=="1"}const o=document.getElementById("showWelcome");o&&o.addEventListener("click",()=>At());const s=document.getElementById("splashStart");s&&s.addEventListener("click",()=>{localStorage.setItem("welcomeSeen","1"),te()});const i=document.getElementById("splashDismiss");i&&i.addEventListener("click",()=>{localStorage.setItem("welcomeSeen","1"),te()}),n?Pe():r.redirectTo&&setTimeout(()=>Re(r.redirectTo),80);const l=document.querySelector("header.topbar");l&&(l.style.zIndex="20");try{const k=document.querySelector("#sidebar .tabs"),E=k?Array.from(k.querySelectorAll('[role="tab"]')):[],S=Array.from(document.querySelectorAll("#sidebar .side-panel")),y=f=>{E.forEach(w=>w.setAttribute("aria-selected",String(w.dataset.tab===f))),S.forEach(w=>{w.hidden=w.getAttribute("data-panel")!==f})};E.forEach(f=>f.addEventListener("click",()=>y(f.dataset.tab))),E.length&&y(E.find(f=>f.getAttribute("aria-selected")==="true")?.dataset.tab||"carriers")}catch{}try{const k=(JSON.parse(localStorage.getItem("cst.settings")||"{}")||{}).theme;ne(k||(e?"light":"dark"))}catch{ne(e?"light":"dark")}document.getElementById("themeToggle")?.addEventListener("click",vt),document.getElementById("openSettingsTop")?.addEventListener("click",()=>F("settings")),document.getElementById("openCopilotBtn")?.addEventListener("click",()=>{document.getElementById("modal-copilot")&&oe()}),document.getElementById("langToggle").addEventListener("click",wt);const d=document.getElementById("helpMenuBtn"),a=document.getElementById("helpMenu"),p=document.getElementById("helpMenuWrap"),h=document.getElementById("helpWelcomeItem");if(d&&a){let k=!1;const E=S=>{k=S,a.style.display=S?"block":"none"};d.addEventListener("click",S=>{S.stopPropagation(),E(!k)}),document.addEventListener("click",S=>{k&&(p&&p.contains(S.target)||E(!1))})}h&&h.addEventListener("click",()=>{try{Ne(),Me(),_e()}catch{}const k=document.getElementById("helpMenu");k&&(k.style.display="none")}),document.getElementById("setupWizard");const u=document.getElementById("openSettings");u&&u.addEventListener("click",()=>F("settings")),document.getElementById("wizardSave").addEventListener("click",Bt),r.settings=Tt();const g=document.getElementById("testsModal"),v=document.getElementById("openTests");v&&v.addEventListener("click",()=>F("tests")),document.getElementById("testsClose").addEventListener("click",()=>g.close()),document.getElementById("testsFetchBtn").addEventListener("click",Dt),document.getElementById("t_run_doctor")?.addEventListener("click",Pt),document.getElementById("t_run_ui_audit")?.addEventListener("click",Nt),document.getElementById("t_run_splash_diag")?.addEventListener("click",Mt),Fe();const c=document.getElementById("denialsModal"),m=document.getElementById("denialsClose");m&&m.addEventListener("click",()=>c?.close());const I=document.getElementById("carrierModal"),B=document.getElementById("carrierClose");B&&B.addEventListener("click",()=>I?.close());try{r.copilotSamples=await fetch("/copilot-prompts.json").then(k=>k.ok?k.json():[])}catch{r.copilotSamples=[]}ae(),Y(),yt(r.lang),qe();const x=document.getElementById("dropzone");x.addEventListener("dragover",k=>{k.preventDefault(),x.classList.add("hover")}),x.addEventListener("dragleave",()=>x.classList.remove("hover")),x.addEventListener("drop",Rt),document.addEventListener("paste",Ot),window.addEventListener("securitypolicyviolation",k=>{const E=k.blockedURI||"";E.includes("vercel.live")||k.violatedDirective!=="style-src-attr"&&(r.cspViolations.push(`${k.violatedDirective} @ ${E||"inline"}`),$())}),$(),jt(),ge(),Ut(),Ht();try{bt()}catch{}try{Wt()}catch{}document.addEventListener("click",k=>{const E=k.target?.closest?.("[data-open]");if(!E)return;const S=E.getAttribute("data-open");if(!S)return;if(S==="tests")return F("tests");if(S==="tools:denials"){he();return}if(S==="settings")return F("settings");if(S==="tools:copilot"){if(document.getElementById("modal-copilot")){oe();return}const L=document.getElementById("copilotSection");L&&L.scrollIntoView({behavior:"smooth",block:"start"});return}if(S.startsWith("carrier:")){const w=S.split(":")[1];kt(w);return}const y={"tools:rpfr":"RPFR / PFR","tools:fmip":"FMIP Script","tools:denials":"Denials","tools:affidavits":"Affidavits","tools:byod":"BYOD Premium Check","tools:smartdrop":"SmartDrop (OCR)",smartdrop:"SmartDrop (OCR)"},f={"product:UBIF":"uBreakiFix","product:RSG":"Repair Service Group","product:HOMEPLUS":"Asurion Home+","product:APPLIANCEPLUS":"Asurion Appliance+","product:VZ_HDP":"Verizon Home Device Protect","product:ATT_HTP":"AT&T Home Tech Protection"};if(y[S]){S==="tools:smartdrop"||S==="smartdrop"?De():(N(`Tool open → ${y[S]} (TODO: modal/panel)`),C(y[S]));return}f[S]&&(N(`Product panel open → ${f[S]} (TODO)`),C(f[S]))})});function bt(){const e=document.getElementById("topSearch"),t=document.getElementById("searchInput"),n=document.getElementById("searchSuggest");if(!t||!n)return;try{if(localStorage.getItem("ui.search")==="0"){e&&(e.style.display="none");return}}catch{}const o=u=>r.i18n?.t?r.i18n.t(u):u,s=[{id:"qa:copilot",label:()=>o("QuickOpenCopilot"),run:()=>{document.getElementById("modal-copilot")?oe():document.getElementById("copilotSection")?.scrollIntoView({behavior:"smooth"})}},{id:"qa:denials",label:()=>o("QuickOpenDenials"),run:()=>he()},{id:"qa:smartdrop",label:()=>o("QuickOpenSmartDrop"),run:()=>De()},{id:"qa:policies",label:()=>o("QuickOpenPolicies"),run:()=>C("Policies hub coming soon")},{id:"qa:xr",label:()=>o("QuickOpenXR"),run:()=>C("XR Library coming soon")},{id:"qa:byod",label:()=>o("QuickOpenBYOD"),run:()=>C("BYOD Check coming soon")},{id:"qa:rpfr",label:()=>o("QuickOpenRPFR"),run:()=>{const u=document.querySelector('[data-open="bucket:rpfr"]');u?u.click():C("RPFR")}}];function i(u){const g=String(u||"").trim().toLowerCase(),v=[];return g?((g.includes("denial")||g.includes("no airtime")||g.includes("deneg"))&&v.push(s.find(c=>c.id==="qa:denials")),(g.includes("rpfr")||g.includes("reimburse"))&&v.push(s.find(c=>c.id==="qa:rpfr")),(g.includes("fmip")||g.includes("icloud")||g.includes("find my"))&&v.push({id:"qa:fmip",label:()=>"Open FMIP Script",run:()=>C("FMIP Script coming soon")}),(g.includes("scan")||g.includes("pdf")||g.includes("ocr"))&&v.push(s.find(c=>c.id==="qa:smartdrop")),v.find(c=>c?.id==="qa:copilot")||v.push(s.find(c=>c.id==="qa:copilot")),v.filter(Boolean).slice(0,4)):v}let l=[],d=-1;function a(u){n.innerHTML="";const g=!!String(u||"").trim(),v=m=>{const I=document.createElement("div");I.className="suggest-label",I.textContent=m,n.appendChild(I)},c=m=>{const I=document.createElement("div");return I.className="suggest-option",I.setAttribute("role","option"),I.dataset.id=m.id,I.textContent=typeof m.label=="function"?m.label():m.label,n.appendChild(I),I};g?(v(o("NextSuggestions")),i(u).forEach(m=>c(m))):(v(o("QuickActions")),s.forEach(m=>c(m))),l=Array.from(n.querySelectorAll('[role="option"]')),d=l.length?0:-1,p(),n.style.display=l.length?"block":"none",t.setAttribute("aria-expanded",l.length?"true":"false")}function p(){l.forEach((u,g)=>u.classList.toggle("active",g===d))}function h(){const u=l[d];if(!u)return;const g=u.dataset.id,v=[...s,...i(t.value)].find(c=>c?.id===g);if(v&&typeof v.run=="function")try{v.run()}catch{}n.style.display="none",t.setAttribute("aria-expanded","false")}t.addEventListener("input",()=>a(t.value)),t.addEventListener("focus",()=>a(t.value)),t.addEventListener("blur",()=>setTimeout(()=>{n.style.display="none",t.setAttribute("aria-expanded","false")},120)),t.addEventListener("keydown",u=>{u.key==="ArrowDown"?(u.preventDefault(),l.length&&(d=(d+1)%l.length,p())):u.key==="ArrowUp"?(u.preventDefault(),l.length&&(d=(d-1+l.length)%l.length,p())):u.key==="Enter"?d>-1&&(u.preventDefault(),h()):u.key==="Escape"&&(n.style.display="none",t.setAttribute("aria-expanded","false"))}),n.addEventListener("mousedown",u=>{const g=u.target?.closest?.('[role="option"]');if(!g)return;const v=l.indexOf(g);v>-1&&(d=v,p(),h())})}function F(e){const t=e==="settings"?"setupWizard":e==="tests"?"testsModal":e,n=document.getElementById(t);n&&(typeof n.showModal=="function"?n.showModal():n.scrollIntoView({behavior:"smooth",block:"start"}))}function C(e){try{console.log("[Toast]",e)}catch{}}function vt(){try{const e=document.documentElement,o=(["theme-dark","theme-light","theme-glass","theme-macos"].find(l=>e.classList.contains(l))||"theme-dark").replace("theme-",""),s=["dark","light","glass","macos"],i=s[(s.indexOf(o)+1)%s.length];ne(i);try{const l=JSON.parse(localStorage.getItem("cst.settings")||"{}")||{};l.theme=i,localStorage.setItem("cst.settings",JSON.stringify(l))}catch{}C("Theme: "+i)}catch{}}function N(e){try{console.debug("[QA]",e)}catch{}}function De(){const e=document.getElementById("modal-smartdrop");if(!e)return C("SmartDrop not available");e.hidden=!1;const t=e.querySelector("[data-close]");t&&(t.onclick=()=>e.hidden=!0);const n=document.getElementById("sd_drop"),o=document.getElementById("sd_file"),s=document.getElementById("sd_preview"),i=document.getElementById("sd_status"),l=document.getElementById("sd_suggest"),d=document.getElementById("sd_suggest_label"),a=document.getElementById("sd_learn"),p=document.getElementById("sd_route_denials"),h=document.getElementById("sd_route_rpfr"),u=document.getElementById("sd_route_fmip");function g(y){i&&(i.textContent=y||"")}function v(y){const f=new Set("a,an,the,of,to,in,for,on,and,or,if,then,with,by,be,is,are,was,were,as,at,from,that,this,it,its,into,you,your,de,la,el,los,las,un,una,para,por,con,en,es,son,era,eran,como,que,esto,este,su".split(","));return(y||"").toLowerCase().replace(/[^\p{L}\p{N}\s]/gu," ").split(/\s+/).filter(w=>w.length>2&&!f.has(w)).slice(0,400)}function c(y,f){try{return JSON.parse(localStorage.getItem(y)||"")||f}catch{return f}}function m(y,f){localStorage.setItem(y,JSON.stringify(f))}function I(y,f,w={}){const T={denials:"cst_bucket_denials",rpfr:"cst_bucket_rpfr",fmip:"cst_bucket_fmip"}[y],D="cst_bucket:"+y;if(!y)return;const A={ts:Date.now(),text:String(f||"").slice(0,2e4),meta:w};if(T){const q=c(T,[]);q.unshift(A),m(T,q.slice(0,200))}const G=c(D,[]);G.unshift(A),m(D,G.slice(0,200))}function B(y,f){const w="cst_route_rules_v1",L=c(w,{});for(const T of v(f))L[T]??={denials:0,rpfr:0,fmip:0},L[T][y]+=1;m(w,L)}function x(y){const w=c("cst_route_rules_v1",{}),L={denials:0,rpfr:0,fmip:0};for(const D of v(y)){const A=w[D];A&&(L.denials+=A.denials,L.rpfr+=A.rpfr,L.fmip+=A.fmip)}const T=Object.entries(L).sort((D,A)=>A[1]-D[1])[0];return{score:L,best:T&&T[1]>0?T[0]:null}}function k(y){const f=x(y||"");if(f.best){l.style.display="";const w=f.best==="rpfr"?"RPFR":f.best==="fmip"?"FMIP":"Denials";d.textContent=`${w} (learned)`}else l.style.display="none",d.textContent=""}["dragenter","dragover"].forEach(y=>n.addEventListener(y,f=>{f.preventDefault(),f.stopPropagation(),n.style.background="#141422"})),["dragleave","drop"].forEach(y=>n.addEventListener(y,f=>{f.preventDefault(),f.stopPropagation(),n.style.background=""})),n.addEventListener("drop",async y=>{const f=y.dataTransfer?.files?.[0];f&&await E(f)}),o.addEventListener("change",async y=>{const f=y.target.files?.[0];f&&(await E(f),o.value="")});async function E(y){g(`Processing "${y.name}"…`),C("Analyzing file…");try{const f=(y.name.split(".").pop()||"").toLowerCase();let w="";if(/(png|jpg|jpeg|bmp|gif|webp|tif|tiff|pdf|heic)$/.test(f))w=await qt(y);else if(/(txt|csv|log|md|json)$/.test(f))w=await y.text();else try{w=await y.text()}catch{w=`[${f.toUpperCase()} unsupported for OCR preview]`}s.value=String(w||"").trim();const L=(s.value.slice(0,240)||"(no text)").replace(/\s+/g," ");N(`SmartDrop: ${y.name}
→ ${L}${s.value.length>240?"…":""}`),k(s.value),g("Ready to route. Tip: edit the text before routing if needed.")}catch(f){g("Error reading file."),C("SmartDrop failed"),N("SmartDrop error: "+(f?.message||f))}}function S(y){const f=s.value.trim();if(!f){C("Nothing to route");return}I(y,f,{from:"smartdrop"}),a?.checked&&B(y,f),C(`Routed to ${y.toUpperCase()}`),g(`Routed to ${y.toUpperCase()} at ${new Date().toLocaleTimeString()}`)}p.addEventListener("click",()=>S("denials")),h.addEventListener("click",()=>S("rpfr")),u.addEventListener("click",()=>S("fmip"))}const Et={DEVICE_INELIGIBLE:{en:{reason:"This device isn’t eligible under the plan.",rebuttal:"We can review alternate coverage options or repair pathways that might fit your device."},es:{reason:"Este equipo no es elegible bajo el plan.",rebuttal:"Podemos revisar opciones alternativas de cobertura o reparación que podrían ajustarse a su equipo."}}};function he(){const e=document.getElementById("denialsModal"),t=document.getElementById("denialsContent");!e||!t||(t.innerHTML=St(Et,r.lang||"en"),e.showModal())}function St(e,t){const n=Object.entries(e||{});return n.length?`<section>${n.map(([s,i])=>{const l=i.en||{},d=i[t]||i.en||{};return`
        <article class="card">
          <h3><code>${M(s)}</code></h3>
          <div class="cols">
            <div>
      ...
      `}).join("")}</section>`:'<p class="muted">No denials defined yet.</p>'}async function kt(e){N(`Carrier hub open → ${e}`);const t=document.getElementById("carrierModal"),n=document.getElementById("carrierContent");if(!(!t||!n)){n.textContent="Loading…";try{const o=await fetch(`/carriers/${e}.json`,{cache:"no-store"}).then(s=>s.ok?s.json():Promise.reject(new Error("Not found")));n.innerHTML=It(o)}catch{n.textContent=`Failed to load carrier ${e}`}t.showModal()}}function It(e){const t=a=>M(String(a||"")),n=(a,p)=>Array.isArray(a)&&a.length?`<ul>${a.map(p).join("")}</ul>`:'<p class="muted">None</p>',o=n(e.tcs,a=>`<li><a href="${t(a.url)}" target="_blank" rel="noreferrer noopener">${t(a.label)}</a></li>`),s=n(e.common_denials,a=>`<li><code>${t(a.key)}</code> — ${t(a.label)}</li>`),i=n(e.fmip?.steps_en,a=>`<li>${t(a)}</li>`),l=n(e.fmip?.steps_es,a=>`<li>${t(a)}</li>`),d=n(e.support_links,a=>`<li><a href="${t(a.url)}" target="_blank" rel="noreferrer noopener">${t(a.label)}</a></li>`);return`
    <h2>${t(e.name||e.id)}</h2>
    <section>
  ...
  `}function Ct(){try{const n=new URLSearchParams(location.search).get("next");if(n)return n}catch{}return localStorage.getItem("redirectAfterSplash")||null}function Re(e){try{if(typeof H=="function"&&H()||!e||typeof e!="string"||e===location.href||e===location.pathname)return;location.href=e}catch{}}async function wt(){const t=(localStorage.getItem("lang")||"en")==="en"?"es":"en";localStorage.setItem("lang",t),r.i18n=await ue(t),r.lang=t,Oe(),Y(),$(),ge()}function Oe(){document.querySelectorAll("[data-i18n]").forEach(t=>t.textContent=r.i18n.t(t.dataset.i18n));const e=document.querySelector("title[data-i18n]");e&&(e.textContent=r.i18n.t(e.dataset.i18n)),document.querySelectorAll("[data-i18n-placeholder]").forEach(t=>t.placeholder=r.i18n.t(t.dataset.i18nPlaceholder))}function ve(e){const t=document.getElementById("splashStep");t&&(t.textContent=r.i18n?r.i18n.t(e):e)}function Pe(){const e=document.getElementById("splash");if(!e)return;e.hidden=!1,e.classList.add("show");try{const d=document.getElementById("splashTitle");if(d&&!document.getElementById("splashTagline")){const a=document.createElement("p");a.id="splashTagline",a.className="muted",a.style.marginTop="4px",a.style.fontSize="14px",a.textContent=r.i18n?r.i18n.t("SplashTagline"):"White-glove support. Faster workflows. Gold-standard results.",d.insertAdjacentElement("afterend",a)}else if(d){const a=document.getElementById("splashTagline");a&&(a.textContent=r.i18n?r.i18n.t("SplashTagline"):a.textContent)}}catch{}const t=document.getElementById("splashBar");t&&(t.classList.remove("run"),requestAnimationFrame(()=>t.classList.add("run")));const n=document.getElementById("splash"),o=n?.querySelector(".banner-inner");o&&(o.setAttribute("tabindex","-1"),o.focus()),ee=d=>{if(d.key==="Escape"&&localStorage.getItem("welcomeSeen")==="1"&&te(),d.key!=="Tab")return;const p=[...n.querySelectorAll("a[href],button,textarea,input,select,[tabindex]:not([tabindex='-1'])")].filter(g=>!g.disabled);if(!p.length)return;const h=p[0],u=p[p.length-1];d.shiftKey&&document.activeElement===h&&(u.focus(),d.preventDefault()),!d.shiftKey&&document.activeElement===u&&(h.focus(),d.preventDefault())},n.addEventListener("keydown",ee),U=0,re(),clearInterval(V),V=setInterval(()=>{U=Math.min(U+7,97),re(),U>=97&&clearInterval(V)},180);const s=document.getElementById("splashRetry");s&&(s.onclick=()=>{clearInterval(V),Pe()});const i=["LoadingUI","LoadingTranslations","CheckingCore","StartingApp"];let l=0;ve(i[l]),clearInterval(ce),ce=setInterval(()=>{l=Math.min(l+1,i.length-1),ve(i[l])},700),j=!1,K=!1,xt()}function re(){const e=document.getElementById("splashPct");e&&(e.textContent=`${U}%`)}function te(){const e=document.getElementById("splash");e&&(e.classList.remove("show"),e.hidden=!0,clearInterval(ce),clearInterval(V),e.removeEventListener("keydown",ee),ee=null)}function xt(){const e=document.getElementById("splashBar"),t=setTimeout(()=>{(!j||!K)&&(j=!0,K=!0,Q())},3e3);if(e){const n=()=>{j=!0,Q(),clearTimeout(t)};e.addEventListener("animationend",n,{once:!0}),setTimeout(n,2600)}else j=!0;Promise.allSettled([fetch("/i18n/en.json",{cache:"no-store"}),fetch("/i18n/es.json",{cache:"no-store"}),fetch("/assets/logo.svg",{cache:"no-store"})]).then(()=>{K=!0,Q(),clearTimeout(t)})}function Q(){if(j&&K){if(U=100,re(),te(),localStorage.getItem("onboarded")==="1")r.redirectTo&&setTimeout(()=>Re(r.redirectTo),60);else{const t=document.getElementById("setupWizard");t&&typeof t.showModal=="function"&&setTimeout(()=>t.showModal(),80)}setTimeout(()=>{const t=document.getElementById("copilotRun");if(t)try{const n=t.getBoundingClientRect(),o=document.elementFromPoint(n.left+2,n.top+2);o===t||t.contains(o)}catch{}},100)}}function Bt(){const e={name:z("#wName"),coach:z("#wCoach"),empId:z("#wEmpId"),ext:z("#wExt"),theme:z("#wTheme"),expertType:document.getElementById("wExpertType")?.value||"english"};if(!e.name||!e.empId||!e.ext)return;Lt(e),localStorage.setItem("splashSeen","1"),document.getElementById("dontShow").checked&&localStorage.setItem("onboarded","1");const t=e.expertType==="bilingual";if(localStorage.setItem("cst_bilingual",t?"1":"0"),localStorage.getItem("cst_output_mode")||localStorage.setItem("cst_output_mode",t?"both":"en"),document.getElementById("setupWizard").close(),$(),localStorage.getItem("welcomeShown")!=="1")try{Ne(),Me(),_e()}catch{}}function z(e){return document.querySelector(e).value?.trim()}function Lt(e){localStorage.setItem("cst.settings",JSON.stringify(e)),r.settings=e,e.theme&&ne(e.theme)}function Tt(){try{return JSON.parse(localStorage.getItem("cst.settings")||"{}")}catch{return{}}}function ne(e){const t=document.documentElement;t.classList.remove("theme-light","theme-dark","theme-glass","theme-macos"),e==="glass"?t.classList.add("theme-glass"):e==="light"?t.classList.add("theme-light"):e==="macos"?t.classList.add("theme-macos"):t.classList.add("theme-dark")}function At(){try{localStorage.removeItem("welcomeSeen");const e=document.getElementById("splash");if(!e)return;e.hidden=!1,e.classList.add("show"),setTimeout(()=>e.classList.remove("show"),1200)}catch{}}function Ne(){if(document.getElementById("modal-welcome"))return;const e=document.createElement("div");e.className="modal-backdrop",e.id="modal-welcome",e.setAttribute("data-testid","welcome-modal"),e.hidden=!0,e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&le()}),e.querySelector("[data-close]")?.addEventListener("click",()=>le()),document.getElementById("welOpenCopilot")?.addEventListener("click",()=>{le();try{if(document.getElementById("modal-copilot"))oe();else{if(!document.getElementById("copilotSection"))try{ae(),Y()}catch{}document.getElementById("copilotSection")?.scrollIntoView({behavior:"smooth",block:"start"})}}catch{}})}function Me(){const e=p=>r.i18n?r.i18n.t(p):p,t=document.getElementById("welTitle"),n=document.getElementById("welBlocks"),o=document.getElementById("welOpenCopilot"),s=document.getElementById("welDontShowLabel");if(!n||!o)return;t&&(t.textContent=e("WelcomeHeadline")),o.textContent=e("CTAOpenCopilot"),s&&(s.textContent=e("Do Not Show Again"));const i=W(),l=i==="en"||i==="both",d=i==="es"||i==="both",a=p=>{const h=document.createElement("section");h.className="wel-block";const u=document.createElement("h4");u.className="muted",u.style.margin="0",u.style.fontWeight="600",u.textContent=p==="es"?"Español":"English";const g=document.createElement("p");g.style.margin="6px 0 0 0",g.textContent=e("WelcomeSubheadline");const v=document.createElement("p");return v.className="muted",v.style.margin="6px 0 0 0",v.textContent=e("WelcomeBody"),h.appendChild(u),h.appendChild(g),h.appendChild(v),h};n.innerHTML="",l&&n.appendChild(a("en")),d&&n.appendChild(a("es"))}function _e(){const e=document.getElementById("modal-welcome");if(!e)return;const t=document.getElementById("welDontShow");t&&(t.checked=!1),e.hidden=!1}function le(e){const t=document.getElementById("modal-welcome");t&&(t.hidden=!0,document.getElementById("welDontShow")?.checked&&localStorage.setItem("welcomeShown","1"))}function oe(){const e=document.getElementById("modal-copilot");if(!e)return;e.hidden=!1;const t=e.querySelector("[data-close]");t&&(t.onclick=()=>e.hidden=!0);const n=document.getElementById("cp_quick_rpfr"),o=document.getElementById("cp_quick_fmip"),s=document.getElementById("cp_in");n&&(n.onclick=()=>s.value="RPFR: customer purchased accessory at retail; requesting reimbursement."),o&&(o.onclick=()=>s.value="FMIP override: customer forgot Apple ID; need safe coaching and Alpha note.");const i=document.getElementById("cp_run");i&&(i.onclick=async()=>{try{ae(),Y()}catch{}const a=document.getElementById("copilotInput");a&&(a.value=s.value);const p=document.getElementById("copilotRun");p&&p.click(),setTimeout(()=>{const h=document.getElementById("copilotEn")?.textContent||"",u=document.getElementById("copilotEs")?.textContent||"",g=document.getElementById("cp_out");g&&(g.value=[h,u&&`

— ES —
`+u].filter(Boolean).join(`
`))},400)});const l=document.getElementById("cp_copy");l&&(l.onclick=()=>{const a=document.getElementById("copilotEn")?.textContent||"",p=document.getElementById("copilotEs")?.textContent||"",h=W(),u=h==="en"?a:h==="es"||r.lang==="es"?p:a;navigator.clipboard.writeText(u).then(()=>C("Copied"))});const d=document.getElementById("cp_copy_all");d&&(d.style.display="none"),$e()}function $e(){const e=document.getElementById("cp_copy");if(!e)return;const t=o=>r.i18n?r.i18n.t(o):o,n=W();n==="en"?e.textContent=t("Copy EN"):n==="es"?e.textContent=t("Copy ES"):e.textContent=r.lang==="es"?t("Copy ES"):t("Copy EN")}async function Dt(){const e=document.getElementById("testsOutput");e.textContent="Running /api/fetch…";try{const t=await fetch("/api/fetch"),n=await t.json();r.lastFetchRun={ok:t.ok,at:new Date().toISOString()},e.textContent=JSON.stringify(n,null,2)}catch(t){e.textContent="Fetch error: "+t.message,r.lastFetchRun={ok:!1,at:new Date().toISOString(),err:t.message}}$()}async function Rt(e){e.preventDefault(),e.currentTarget.classList.remove("hover");const t=e.dataTransfer.files?.[0];if(t)if(t.type==="text/plain"){const n=await t.text();Z(ke(n))}else t.type==="application/pdf"||t.name.endsWith(".pdf")?Z({error:"PDF parsing stub — add pdf.js (self-hosted) later."}):Z({error:`Unsupported type: ${t.type||t.name}`})}function Ot(e){const t=e.clipboardData?.getData("text");t&&t.length>5&&Z(ke(t))}function Z(e){document.getElementById("preview").textContent=JSON.stringify(e,null,2)}async function Fe(){const e=document.getElementById("ocrBadge");if(!e)return;try{const o=await fetch("/api/doctor?check=ocr");if(o.ok){const s=await o.json();s.ok&&s.ocr?.ready?(e.textContent="OCR: Ready ✅",e.style.borderColor="#16a34a"):(e.textContent="OCR: Offline ⚠️",e.style.borderColor="#ffb020",s.ocr?.missing?.length&&(e.title="Missing: "+s.ocr.missing.join(", ")));return}}catch{}const t=["/libs/tesseract/tesseract.min.js","/libs/tesseract/worker.min.js","/libs/tesseract/tesseract-core.wasm"],n=[];await Promise.all(t.map(async o=>{try{(await fetch(o,{method:"HEAD",cache:"no-store"})).ok||n.push(o)}catch{n.push(o)}})),n.length===0?(e.textContent="OCR: Ready ✅",e.style.borderColor="#16a34a"):(e.textContent="OCR: Offline ⚠️",e.style.borderColor="#ffb020",e.title="Missing: "+n.join(", "))}async function Pt(){const e=document.getElementById("testLog")||document.getElementById("testsOutput"),t=document.getElementById("t_run_doctor"),n=new Date().toISOString();if(t){if(t.disabled){console.log(`[${n}] Doctor test already running, ignoring request`);return}t.disabled=!0,t.textContent="Running..."}console.log(`[${n}] Doctor test started`),e&&(e.textContent=`Doctor: running… [${n}]`);try{console.log(`[${n}] Fetching /api/doctor`);const o=await fetch("/api/doctor",{method:"GET",cache:"no-store",headers:{"X-Request-ID":`doctor-${Date.now()}-${Math.random().toString(36).substr(2,9)}`}});console.log(`[${n}] Doctor response status:`,o.status);const s=await o.json();console.log(`[${n}] Doctor response:`,s),e&&(e.textContent=JSON.stringify(s,null,2)),Fe(),C(s.ok?"Doctor passed":"Doctor found issues")}catch(o){console.error(`[${n}] Doctor error:`,o),e&&(e.textContent="Doctor error: "+(o?.message||o)),C("Doctor error")}finally{t&&(t.disabled=!1,t.textContent="Doctor")}}function Nt(){const e=document.getElementById("testLog")||document.getElementById("testsOutput");e&&(e.textContent="UI Text Audit: scanning…");try{const t=a=>{if(!a)return!1;const p=getComputedStyle(a);return p&&p.display!=="none"&&p.visibility!=="hidden"&&a.offsetParent!==null},n=[],o=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,null);let s;for(;s=o.nextNode();){const a=(s.nodeValue||"").replace(/\s+/g," ").trim();if(!a)continue;const p=s.parentElement;if(!p||!t(p))continue;const h=p.tagName;h==="SCRIPT"||h==="STYLE"||h==="CODE"||h==="PRE"||n.push(a)}const i=[],l=/([A-Za-zÀ-ÿ0-9][A-Za-zÀ-ÿ0-9\-']*)(?:\s+\1){2,}/i;n.forEach((a,p)=>{l.test(a)&&i.push({i:p,type:"repeat-token",line:a}),p>0&&n[p-1]===a&&i.push({i:p,type:"repeat-line",line:a})});const d={totalLines:n.length,issues:i.slice(0,50),hint:"Look for repeat-token or repeat-line entries."};e&&(e.textContent=JSON.stringify(d,null,2))}catch(t){e&&(e.textContent="UI Text Audit error: "+(t?.message||t))}}function Mt(){const e=document.getElementById("testLog")||document.getElementById("testsOutput");e&&(e.textContent="Splash diagnostics: collecting…");try{const t=document.getElementById("splash"),n=document.getElementById("splashStep")?.textContent||"",o=document.getElementById("splashPct")?.textContent||"",s=t?.classList.contains("show"),i=!!t?.hidden,l=localStorage.getItem("welcomeSeen")||"0",d=localStorage.getItem("onboarded")||"0",a={showClass:s,hidden:i,step:n,pct:o,welcomeSeen:l,onboarded:d};e&&(e.textContent=JSON.stringify(a,null,2))}catch(t){e&&(e.textContent="Splash diagnostics error: "+(t?.message||t))}}function ae(){if(document.getElementById("copilotSection"))return;let e=document.querySelector(".content");e||(e=document.createElement("div"),e.className="content",document.body.appendChild(e));const t=document.createElement("section");t.id="copilotSection",t.setAttribute("data-testid","copilot-section"),t.innerHTML=`
